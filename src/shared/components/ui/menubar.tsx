...
function MenubarTrigger({
	...
	return (
		<DropdownMenuTrigger
			...
			className={cn(
				'flex items-center rounded-sm px-2 py-1 text-sm font-medium outline-hidden select-none hover:bg-white/5 aria-expanded:bg-white/5 leading-4 text-muted-foreground',
				className
			)}
			{...props}
		/>
...
function MenubarItem({
	...
	return (
		<DropdownMenuItem
			...
			className={cn(
				"group/menubar-item gap-2 rounded-sm px-2 py-1 text-xs focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground data-inset:pl-8 data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 data-[variant=destructive]:focus:text-destructive dark:data-[variant=destructive]:focus:bg-destructive/20 data-disabled:opacity-50 [&_svg:not([class*='size-'])]:size-4 data-[variant=destructive]:*:[svg]:text-destructive!",
				className
			)}
			{...props}
		/>
